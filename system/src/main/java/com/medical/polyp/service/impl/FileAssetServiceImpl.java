...
import com.medical.polyp.mapper.FileAssetMapper;
...
public class FileAssetServiceImpl implements IFileAssetService
{
    ...
    public FileAsset uploadSourceFile(MultipartFile file)
    {
        try
        {
            String baseDir = MedicalConfig.getUploadPath() + File.separator + sourceDir;
            ...
            String storePath = MedicalConfig.getProfile() + File.separator + relativePath.replace("/", File.separator);
