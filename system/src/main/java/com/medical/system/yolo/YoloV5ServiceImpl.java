...
public class YoloV5ServiceImpl {
     ...
     * YOLOv5 模型文件路径
     */
    private static final String MODEL_PATH = "M:/0NUIST/class/bysj/Medical-platform-master/system/src/main/resources/yolo/polyp.pt";

    /**
     * Python 检测脚本路径
     */
    private static final String DETECT_SCRIPT = "M:/0NUIST/class/bysj/Medical-platform-master/system/src/main/resources/yolo/detect.py";
