...
import com.ruoyi.system.yolo.YoloResult;
import com.ruoyi.system.yolo.YoloV5ServiceImpl;
import com.ruoyi.system.yolo.BoundingBox;
...
public class HisDetectionController extends BaseController
{
                                    ...
                                    @RequestParam(value = "patiId", required = false) Long patiId) throws Exception
    {
        ...
        // 上传文件
        String filePath = FileUploadUtils.upload(RuoYiConfig.getUploadPath() + "/detection/", file);
        String fileName = filePath.substring(filePath.lastIndexOf("/") + 1);

        // 执行 YOLOv5 检测
        String fullPath = RuoYiConfig.getUploadPath() + "/detection/" + fileName;
