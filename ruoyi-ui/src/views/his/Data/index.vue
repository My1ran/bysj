...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除订单审核编号为"' + purOrderIds + '"的数据项？').then(function() {
        return delData(purOrderIds);
      }).then(() => {
        this.getList();
